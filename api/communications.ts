...
const apiUrl = "http://192.168.244.4:8080/";
...
function errorHandler(error: any): AxiosResponse {
  ...
  return {
    status: 600,
    data: { message: "The server couldn't be reached. Please try again later.", success: false },
    headers: {},
    statusText: "The server couldn't be reached. Please try again later.",
    config: {} as any,
  };
}
