...
export function inputBuilder(placeholder: string, valueName: string, formik: any, additionalProps?: any, ref?: any) {
  return (
    <>
      ...
      {formik.touched[valueName] && formik.errors[valueName] ? <Text style={{ fontSize: 18, color: "red", paddingHorizontal: 15, paddingLeft: 20 }}>{formik.errors[valueName]}</Text> : null}
    </>
  );
}
  ...
  return (
    <View style={styles.inputContainer}>
      <TextInput
        ...
        {...additionalProps}
      />
      <TouchableOpacity onPress={() => setSecureText(!secureText)} style={styles.iconStyle}>
